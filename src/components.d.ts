...
declare module '@stencil/core' {
  export namespace JSX {
    interface IntrinsicElements {
      ...
      'ftb-cup-net-explorer-img-layer': LocalJSX.FtbCupNetExplorerImgLayer &
        JSXBase.HTMLAttributes<HTMLFtbCupNetExplorerImgLayerElement>;
      'ftb-cup-net-explorer-stories': LocalJSX.FtbCupNetExplorerStories &
        JSXBase.HTMLAttributes<HTMLFtbCupNetExplorerStoriesElement>;
